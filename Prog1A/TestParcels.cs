...
//
//It creates several different Parcels and places them in a list which is displayed in the console as
// the default order of the list, the CalcCost sorted (ascending) order of the list, and the ZipCode sorted
